      ...
      <ul className="flex flex-wrap items-center gap-1">
        {topics.map((topic, index) => (
          <li key={index}>
            ...
            <p className="flex items-center w-full cursor-default font-semibold xl:text-sm text-xs 2xl:text-base text-purple-600 dark:text-white bg-white dark:bg-purple-400 px-[3.8px] min-[375px]:px-[10px] md:px-2 rounded-md">
              {topic}
            </p>
          </li>
        ))}
