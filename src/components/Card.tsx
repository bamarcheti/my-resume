...
export const Card: React.FC<Props> = ({ title, period, description }) => {
  ...
  return (
    <div className="flex flex-col justify-center text-center rounded-3xl bg-purple-400 dark:bg-stone-800 xl:pb-8 xl:pt-6 xl:px-12 p-4 px-7 gap-4 transition ease-in-out hover:scale-105">
