  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4">
      <div className="flex flex-col gap-2 pt-0 lg:pt-2">
        ...
        <p className="align-center text-xs lg:text-sm font-normal text-purple-600">{period}</p>
        <ul className="flex flex-col gap-1 list-disc list-inside text-sm lg:text-base font-normal text-stone-900 dark:text-white">
